...
The base model Qwen2.5-7B-Instruct is first supervised finetuned with 500 traces generated by o3 using LoRA. The baseline game completion rates of this supervised finetuned model is less than 5%.
